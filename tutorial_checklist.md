...
- [x] Notebook 2 defaults to precomputed official DGAT predictions, never to the ridge baseline.
- [x] Notebook 3 prints the prediction method and evaluation caveat before metrics.
